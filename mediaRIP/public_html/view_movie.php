...
<a href="<?php echo '/mediaRIP/public_html/view_movie.php?id='.$Id.'&username='.$username.'&download';?>"> <div id='del'>


     <!--welcome.php?movies&username=<?php //echo $username;?>-->       
       <!--- <input type="text" placeholder="What are you looking for?">   -->
      <img  src='../raw/pics/download.png' id='del1' style='height:19px;;z-index:16;position:fixed;top:3.2%;right:14.8%;'  value=''> 
...
if(isset($_POST['delete_x'])){
 ...
 $query = query(" SELECT * FROM media WHERE media_id = $Id ");
   ...
   // echo $ex1;
    ...
    $query = query(" DELETE FROM movies WHERE movie_id = $Id ");
    
    confirm($query);

    $det1='welcome.php?movies&username='.$username;
...
<li style="float:right;margin-right: 3%;margin-top: -0.1%;">
...
<video width="80%" height="75%" controls  preload= "auto">
...
<div id="container1">
     ...
     error_reporting(E_ALL); 
      ...
      $query = query(" SELECT * FROM movies WHERE movie_id = $Id" );
...
if (screenWidth<1000){
    ...
    document.getElementById("un").style.height = '40%';
          ...
          document.getElementById("myBtn1").style.marginTop= "-10";
