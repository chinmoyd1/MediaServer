...
if($exist == '1'){
    echo "<a href='http://".$ip."/miniBrowser/public_html/index.php?username=".$username."&destination=http323".$ip1."626external626&".$arr."'><div id='usb'><img src="; 
  echo "../raw/pics/usb1.png height='50px'></div>";
...
$dt = formatSize($dt);
 ...
 echo "<h6>$du of $dt used</h6>"; 
  ...
  echo "../raw/pics/usb.png height='50px'></div>";
  echo "<h1>USB 0 ( Mass storage )</h1>";
...
if($exist == '1'){
  ...
  echo "<a  href='http://".$ip."/miniBrowser/public_html/index.php?username=".$username."&destination=http323".$ip1."626external1626&".$arr."'><div id='usb'><img src="; 
  echo "../raw/pics/usb1.png height='50px'></div>";
...
if($exist == '1'){
    echo "<a href='http://".$ip."/miniBrowser/public_html/index.php?username=".$username."&destination=http323".$ip1."626external2626&".$arr."'><div id='usb'><img src="; 
  echo "../raw/pics/usb1.png height='50px'></div>";
...
if($exist == '1'){
    echo "<a href='http://".$ip."/miniBrowser/public_html/index.php?username=".$username."&destination=http323".$ip1."626external3626&".$arr."'><div id='usb'><img src="; 
  echo "../raw/pics/usb1.png height='50px'></div>";
...
?>
 ...
 <script>
function address(){
var url = "<?php echo (isset($_SERVER['HTTPS']) ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"; ?>";
alert(url);
}
</script>
