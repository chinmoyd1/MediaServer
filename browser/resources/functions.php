			...
			if (!isset($_POST['product_category_id']) || !$_FILES["video"]["name"] || $_POST['product_title'] == "Edit media name...")
			{
				...
				return;
					...
					{	
						...
						$query3 = query("INSERT INTO tvSeries(title,poster,year,rated,released,runtime,genre,director,writer,actor,plot,language,country,awards,totalseason) VALUES('{$media_title}','{$media_poster}','{$year1}','{$rated1}','{$released1}','{$runtime1}','{$genre1}','{$director1}','{$writer1}','{$actor1}','{$plot1}','{$language1}','{$country1}','{$awards1}','{$totalseason}')");
...
<div id="bt"  style="position:absolute;top:94.4%;left:60%;z-index:4"> <input type='submit'  name='uploadSeason' value='UPLOAD ANOTHER SEASON' onclick='uploadFile()'></div>    
...
echo '<img src=" ' . $media_poster .'" style="width:300px;" >' ;
...
<div id="bt"  style="position:absolute;top:94.4%;left:60%;z-index:4"> <input type='submit'  name='uploadSeason1' value='UPLOAD ANOTHER SEASON' onclick='uploadFile()'></div>    
